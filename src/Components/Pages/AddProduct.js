...
function AddProduct() {
  ...
  return (
    <div  className='admin-page'>
         ...
         <input type='text' name="product_name" className="product_name" placeholder="ProductName" onChange={handleChange}/>
         <input type="text" name="product_brand" className="product_brand" placeholder="ProductBrand" onChange={handleChange}/>
         <input type="text" name="product_details" className="product_details" placeholder="ProductDetails" onChange={handleChange}/>
         ...
         <input type="text" name="product_price" className="product_price" placeholder="Productprice" onChange={handleChange}/>
         <input type="text" name="product_orgprice" className="product_orgprice" placeholder="Productprice" onChange={handleChange}/>
        ...
        <input type="number" name="product_rating" className="product_rating"  max="5" min="0" onChange={handleChange}/> 
